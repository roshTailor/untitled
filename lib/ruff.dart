...
//                           "Login",
//                           style:
//                               TextStyle(color: Color(0xff2E2F32), fontSize: 36),
//                         ),
//                         SizedBox(
//                           height: h / 40,
//                         ),
...
//                                 ),
//                                 child: TextFormField(
//                                   controller: Variable.loginUserName,
//                                   validator: (val) {
//                                     if (val!.isEmpty) {
...
//                                 child: TextFormField(
//                                   obscureText: true,
//                                   controller: Variable.loginPassword,
//                                   validator: (val) {
//                                     if (val!.isEmpty) {
//                                       return 'Please enter this details';
//                                     }
...
//                                     const Color(0xff5447B6),
//                                   ),
//                                 ),
//                                 onPressed: () {
//                                   setState(() {
//                                     if (Variable.login.currentState!
//                                         .validate()) {
